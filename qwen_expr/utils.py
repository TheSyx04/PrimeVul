...
PROMPT_INST = """Please analyze the following code change:
```
{func}
```
...
PROMPT_INST_COT = """Please analyze the following code change:
```
{func}
```
Please indicate your analysis result with one of the options: 
...
ONESHOT_USER = """Please analyze the following code change:
```
...
TWOSHOT_USER = """Please analyze the following code change:
```
